...
I struggled to show the user signing up, but it is implemented. The user can post, but I had trouble with images so I tried showing the logs stating the posts were successfully pulled.
